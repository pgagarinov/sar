...
- **PROMPT EDITS ONLY VIA HARNESS** — `.claude/` files in any repo are NEVER edited directly. Use the prompt-edit pixi tasks (`pixi run dot-claude-edit`, `pixi run target-dot-claude-edit`). These log, diff, and auto-commit every change.
